      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-4" data-aos="fade-up">
            <h3>Cegah Stunting dengan isi piringku</h3>
            <p class="fst-italic">
            Salah satu cara efektif untuk mencegah stunting adalah dengan memenuhi kebutuhan gizi yang seimbang sesuai panfuan "isi piringku", yang disarankan oleh kementerian kesehatan RI. Panduan ini terdiri dari makanan pokok, lauk hewani, lemak, dayur dan buah.
            </p>
            <ul>
