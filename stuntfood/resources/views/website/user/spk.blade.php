            ...
            <div class="row">
                <div class="col">
                    <div class="card mb-4  shadow">
                        ...
                        <div class="card-header  d-flex justify-content-between align-items-center">
                            <h5 class="fw-bold py-1 mb-0"><span class="text-muted fw-light"></span>#Berat Makanan Yang
                                disesuaikan</h5>
                        </div>

                        <!-- Misalkan, kode HTML yang lain di sini -->
                                ...
                                <tbody class="table-border-bottom-1">
                                    ...
                                    @foreach ($query as $item)
                                        <tr>
                                            ...
                                            <th>{{ $item->jenis }}</th>
                                            <td>
                                                @if ($item->jenis == 'makananpokok')
                                                    {{ $b }}
                                                @elseif ($item->jenis == 'lauk')
                                                    {{ $bl }}
                                                @elseif ($item->jenis == 'sayur')
                                                    {{ $bs }}
                                                @elseif ($item->jenis == 'buah')
                                                    {{ $bh }}
                                                @else
                                                    Data Tidak Valid
                                                @endif
