         ...
         <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
             <div class="app-brand demo">
                 <a href="index.html" class="app-brand-link">
                     ...
                     <span class="app-brand-text demo menu-text fw-bolder ms-2">StuntFood</span>
                 </a>
             ...
             <ul class="menu-inner py-1">
                 <li class="menu-item active">
                     <a href="{{ url('/spk') }}" class="menu-link">
                         ...
                         <div data-i18n="Analytics">Rekomendasi Menu Makan</div>
                     </a>
                 </li>
             ...
             <a href="javascript:void(0);" class="menu-toggle" id="menu-toggle">
